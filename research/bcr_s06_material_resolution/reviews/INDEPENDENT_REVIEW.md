...
## Bounded variable-area geometry follow-up

The regional-geometry demonstration was reviewed at source `0f2ac4d8ed8556b1f9b161201deccde446338219cc3ab18340632a3a4fb520c2`. Five tests passed independently (0.50 s). The manufactured controls were independently replayed to a separate output with exact agreement apart from timing. The nonlinear-area FE defect and unequal-speed final-RK defect were checked with exact rational arithmetic, including another case with opposite-sign face speeds.

The proposed authoritative cumulative-volume coordinate W avoids the particular discrete volume-combination inconsistency; this is a change of geometry time discretization requiring adjudication, not a storage-only change. Exact inverse brackets/residuals do not make rounded x an exact inverse. The static-fluid moving-mesh experiment establishes algebra/GCL consistency only. It does not establish variable-pressure transport, segment/event handling, a general production residual policy, or any complete numerical fixture PASS. See geometry-review.json.
