    ...
    for pair, (yl, yr, tl, tr) in enumerate(pairs):
        for velocity in (0.,100.,-100.):
            ...
            evidence={'initial_edges':initial.edges.tolist(),'initial_inventory':initial.inventory.tolist(),
                      ...
                      'final_labels':state.labels,'stages':solver.stage_records,'remaps':solver.remap_records,'transactions':solver.transaction_records,'derived_records':solver.records,'transactions':solver.transaction_records,'derived_records':solver.records}
